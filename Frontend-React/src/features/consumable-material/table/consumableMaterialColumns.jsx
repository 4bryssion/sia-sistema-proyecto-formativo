...
// Componente que contiene los botones de acciones (editar, entre otras) para cada material consumible
import ConsumableMaterialRowActions from "../components/ConsumableMaterialRowActions";

// Definición de las columnas de la tabla de material consumible
...
export const consumableMaterialColumns = [
    ...
    // Columna Nombre
    {
    accessorKey: "nombre_material", // Campo del objeto material consumible
    ...
    cell: ({ row }) => {
        ...
        // Se obtiene el objeto completo del material consumible de la fila
        const consumableMaterial = row.original;

        // Función que se ejecuta cuando cambia el switch
        const handleChange = (value) => {

            // value representa el nuevo estado del switch (true o false)
            console.log("Actualizar estado material consumo:", consumableMaterial.consumableMaterial_id, value);
        ...
        return (
            ...
            <Switch
                checked={consumableMaterial.is_active} // Estado actual del usuario
    ...
    {
        id: "actions", // No usa accessorKey porque no corresponde a un campo del material consumible


        // Renderiza el componente de acciones pasando el material consumible completo
        cell: ({ row }) => <ConsumableMaterialRowActions consumableMaterial={row.original} />,
    },
];
